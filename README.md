...
- 🎬 **Micro-interactions** - Preloader with counter, custom blend-mode cursor that turns into a "reading lens" revealing hidden alternate paragraphs and whispers caption pills over key elements, cursor-following project previews, row-inversion hovers, film grain, marquee
